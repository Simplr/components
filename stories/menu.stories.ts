...
const Menu: Story<ArgTypes> = ({ elevated, interactable }: ArgTypes) => {
    let isOpen = false;
    function toggleMenu() {
        if (isOpen) {
            isOpen = false;
    ...
    return html`
        ...
        <simplr-menu ?elevated=${elevated} ?visible=${!interactable} dir="down">
            ...
            <simplr-menu-item>
                Settings
                <svg slot="icon-before" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24">
                    <path
