 ...
 *
 * */
let SimplrLoading = class SimplrLoading extends LitElement {
    constructor() {
        super(...arguments);
        this.align = 'center;';
    }
...
], SimplrLoading.prototype, "align", void 0);
SimplrLoading = __decorate([
    customElement('simplr-loading')
], SimplrLoading);
export { SimplrLoading };
