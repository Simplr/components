...
export class SimplrNotification extends LitElement {
    ...
    public static open(options: SimplrNotificationOptions) {
        ...
        if (typeof options.timeout !== 'undefined') {
            ...
            notification.style.setProperty('--animation-duration', `${options.timeout}ms`);
        }
    ...
    render(): TemplateResult {
        return html`
            <div class="notification">
                ...
                <div class="exit-button" @click=${this.closeNotification} @keydown=${this.closeNotificationKeyboard}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <path d="${errorSign}" />
                    </svg>
                </div>
